...
public interface StorageManageService {
     ...
     * @param num 下发数量
     */
    List<Card> takeCard(Integer num);
    ...
    List<Card> cardList(String cardNum);

    void updateCardSell(String sate ,String nameSell,List<Card> cards);
    void updateDestroyCard(String sate,List<Card> cards);

    List<Card> selectCardSellEnd();

    List<Card> selectCardSellEndAll();
}
