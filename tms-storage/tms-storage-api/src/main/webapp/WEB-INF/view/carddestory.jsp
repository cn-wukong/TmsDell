...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <aside>
        ...
        <section id="main-content">
          ...
          <section class="wrapper">
              ...
              <div class="alert alert-success"> ${message}</div>
                 <!--  搜索领卡人信息点 -->
                        <form class="navbar-form" id="souForm" action="/card/account" method="GET">
                            <input class="form-control" placeholder="输入购票人账号" value="" name="souAccount" type="text">
                        </form>
		...
		<form class="form-horizontal" id="dongjieAccount" action="/card/destory/now" method="post">
            <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3" >姓名</label>
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess1" aria-describedby="inputSuccess3Status" value="小李子" name="name">
            </div>
            </div>
            <div class="form-group has-default has-feedback">
                <label class="control-label col-sm-3" for="inputSuccess3">卡号</label>
                <div class="col-sm-9">
                    <input type="text" readonly class="form-control" id="inputSuccess2" aria-describedby="inputSuccess3Status" value="${cardnum}" name="cardnum">
                </div>
            </div>
             <div class="form-group has-default has-feedback">
              ...
              <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess4" aria-describedby="inputSuccess3Status" value="2015-10-12" name="CreatTime">
             </div>
            </div>
             ...
             <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess5" aria-describedby="inputSuccess3Status" value="0" name="dataNumber">
            </div>
            </div>
            ...
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                <input type="text" readonly class="form-control" id="inputSuccess6" aria-describedby="inputSuccess3Status" value="冻结" name="state">
            </div>
            </div>
        </form>
        <br>
            <div class="form-group has-default has-feedback">
                ...
                <div class="col-sm-9">
                 <button type="button" class="btn btn-primary btn-lg" id="dongjie">作废</button>
            </div>
            </div>
