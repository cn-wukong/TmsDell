...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
              ...
              <div class="alert alert-success"> ${message}</div>
                 <!--  搜索领卡人信息点 -->
                        <form class="navbar-form" id="sousuocardPerson" action="/card/person" method="GET">
                            <input id="sousuokuang" class="form-control" placeholder="输入购票人账号" type="text" value="" name="person">
                        </form>
		...
		<form class="form-horizontal" id="sellCardForm" action="/card/sell/address" method="POST">
